...
\begin{enumerate}[label=(\alph*)]
    \item \label{2231a}每位球员都使用相同的白母球且有二十一颗目标球——十五颗每颗1分的红球，以及六颗彩球：2分的黄球、3分的绿球、4分的棕球、5分的蓝球、6分的粉球和7分的黑球\footnote{不是八球！！！不是8分！！！}。\\
    ...
    \item 球员的击球轮内的得分击球被通过交替地将红球和彩球击球入袋直到所有红球都离开台面且之后将彩球按其分值从低到高的顺序击球入袋来进行。\\
    ...
    \item 一个在整局内的任何时候都被采用的战术是让母球留在一颗非活球的后面以致其对下一位球员而言被做斯诺克。如果一位球员或一方需要[获得]比通过台面上剩余的球能得到的分数更多的分数[才能获胜]，那么做斯诺克期待因[对方的]犯规而获得分数变得最为重要。\\
    ...
    \item 一局的胜者是某球员或某方，此球员或此方：\\
    The winner of a frame is the player or side:
    \begin{enumerate}[label=(\roman*)]
        \item 是有最高分数的；\\
        with the highest score;
        \item 是此局[对方]向己方认输的；或\\
        to whom the frame is conceded; or
        \item 是此局被[裁判]根据第\ref{223}节的规则\ref{22314}\ref{22314d}\ref{22314dii}或第\ref{224}节的规则\ref{2241}\ref{2241b}、\ref{2241}\ref{2241d}、\ref{2243}\ref{2243b}或\ref{2243}\ref{2243c}判定己方赢得的。\\
...
\begin{enumerate}[label=(\alph*)]
    ...
    \begin{enumerate}[label=(\roman*)]
        \item ${}$[全部]红球呈一个紧密相贴的等边三角形，且顶端的红球位于球台\longitudinalline{}上，粉球点上方以致其会尽可能接近粉球点但不占之，并且[红球]三角形的底边与顶库平行；\\
        ...
        \item 六颗彩球在第\ref{221}节规则\ref{2211}\ref{2211f}中所\designate{}的[各自的]点位上。\\
        the six colours on the spots designated in Section \ref{221} Rule \ref{2211}\ref{2211f}.
    \end{enumerate}
    \item 如果一个台面[初]设中的错误被造成，那么第\ref{223}节规则\ref{2237}\ref{2237c}应适用，此局如第\ref{223}节规则\ref{2233}\ref{2233c}中[所述]地开始。\\
    ...
    \begin{enumerate}[label=(\roman*)]
        ...
        \item \label{2232cii}此被用于标注球的位置的装置应被视为此球，并得到此球的分值，直至此球已被摆回完成之时。如果任意球员接触此装置那么是违规。裁判应将相应的罚分加给非违规方并且，若有必要，则将此装置或此球摆回它原来的位置且即使它被拿起[也如此处理]。\\
        the device used to mark the position of a ball shall be regarded as, and acquire the value of, the ball until such time as the ball has been replaced. It is an infringement if any player contacts the device. The referee shall award the relevant penalty points to the non-offender and replace the device or ball to its original position, if necessary, even if it was picked up.
...
\noindent 球员们应以抽签或以任意双方都同意的方式决定比赛次序，[抽签的]胜者有哪位球员首先击打的选择权。\\
...
\begin{enumerate}[label=(\alph*)]
    \item 被因此决定的比赛次序必须在整局内保持不变，但有例外是球员在任何[自己造成的]犯规后都可以被下一位球员要求再次击打。\\
    ...
    \item \label{2233c}首先[击打的]球员从手中球状态起击打，此局开始于某时，此时母球已被摆放到\playingarea{}中并且已被球杆的皮头接触且被接触时：\\
    ...
    \begin{enumerate}[label=(\roman*)]
        ...
        \item 若另一次击球被进行或一次违规在首次击球中或首次击球完成后被造成，则其应按正常方式继续，且开[局]的正确次序应在下一局中被恢复以致某球员或某方将在连续三局中开[局]完成；或者\\
        ...
        \item \label{2233diii}若僵局事件被\declare{}(\see{}第\ref{223}节规则\ref{22317})，则其应被正确的某球员或某方重新开启。\\
    ...
    \item 对每个击球轮的首次击球，红球或某被指定当成红球的自由球是活球，并且在相同的击球内被击球入袋的每个红球和任何被指定当成红球的自由球的分数都被记录，直到所有红球都离开台面。\\
    ...
    \item \label{2233h}
    \begin{enumerate}[label=(\roman*)]
        \item 如果一颗红球，或一颗被指定当成红球的自由球，被击球入袋，那么相同的球员进行下一次击球并且下一颗活球是一颗依击球手选择的彩球，若该彩球被击球入袋，则其被计分且彩球随后被摆上点位。\\
        ...
        \item 单杆被通过交替地将红球和彩球击球入袋延续直到所有红球都离开台面并且，在适用[规则]时，一颗彩球已在最后一颗红球的击球入袋后被击打。\\
        ...
        \item \label{2233hiii}彩球随后根据第\ref{223}节规则\ref{2231}\ref{2231a}按其分值从低到高的顺序成为活球且在下一次被击球入袋时保持离开台面，除非是如第\ref{223}节规则\ref{2234}中所规定的[情形]，并且击球手对下一颗活球彩球进行下一次击球。\\
        ...
        \item 如果, 在某次单杆中的, 击球手在裁判已在其他所有球都静止时完成将某彩球摆上点位前击打，那么该彩球的分数不应被记录并且第\ref{223}节规则\ref{22311}\ref{22311a}\ref{22311ai}或 \ref{22311}\ref{22311b}\ref{22311bii}应视情况适用。\\
    ...
    \item 如果击球手未能将球击球入袋，那么他们必须下台且不带不适当的耽搁。如果他们在下台前或下台时造成任意犯规，那么他们会被如第\ref{223}节规则\ref{22311}中所规定地处罚。下一次击球随后被在母球静止处进行，或若母球不处于比赛中状态则被从手中球状态起进行，除非当母球被根据第\ref{223}节规则\ref{22310}\ref{22310i}、\ref{22314}\ref{22314e}和\ref{22316}摆回时。\\
    ...
    \item \label{2233k}如果非击球手，在[自己的]击球轮外，上台并造成任意违规那么是\termpenalty{}。裁判应宣告“\termpenalty{}”并且任何被移动的球都应被摆回其违规前的位置，并且击球手的击球轮会不受影响地继续。\\
    ...
    \item 在对方击球轮的最后一次击球后，或一次犯规后，如果正上[台]的球员在[所有]球[都]已静止前，或裁判已完成将某彩球摆上点位前，击打母球或造成一次违规，那么他们应被好像他们是击球手一样地处罚并且他们的击球轮会结束。\\
    ...
    \item 如果任意球进入球袋又反弹上\playingarea{}，那么它不被算作已被击球入袋或掉袋。如果此[情形]出现那么所有球员都没有补偿。\\
...
\begin{enumerate}[label=(\alph*)]
    \item \label{2234a}当黑球是台面上仅剩的目标球时，首次入袋或犯规结束此局且例外只有下面的条件都满足：\\
    ...
    \end{enumerate}
    \item 当累计得分决定一场或一次比赛的胜者，且最后一局结束[双方]累计得分相等时，此局中的球员们应遵照上面\ref{2234b}中所陈述的，习惯上被称为\respotted{}黑球的，程序[决出胜者]。\\
...
\noindent 为自手中球状态击打，母球必须在D形区边线上或边线内的某个位置被球杆的皮头接触，但它可以被朝任意方向击打。\\
...
\begin{enumerate}[label=(\alph*)]
    ...
    \item 如果放置母球时球杆的皮头触碰之，而裁判[根据实际情况]认为击球手不是正在尝试进行一次击球\footnote{例如击球手是正在用球杆拨动母球以移动母球至自己满意的位置。}，那么[此时]母球不处于比赛中状态。\\
...
\noindent 不是两颗红球或一颗自由球和一颗活球的，两颗球禁止在母球的首次撞击中被同时击中。\\
...
\begin{enumerate}[label=(\alph*)]
    ...
    \item 如果一颗彩球在根据第\ref{223}节规则\ref{2233}\ref{2233h}\ref{2233hiii}按[分值]从低到高的顺序被击球入袋后被错误地摆上点位，那么该错误被发现时它应被[立即]从台面移除且无处罚，并且比赛应从因此产生的状态继续。如果该彩球已被击球入袋后该错误[才]被发现, 那么[若]下一次击球被进行后或一次违规在下一次击球被进行前被造成后[该错误才被发现] [则]已得到的分数应算入。\\
    ...
    \begin{enumerate}[label=(\roman*)]
        \item 如果[彩球不正确地]不在[台面]是因之前的疏忽所致，那么[不在台面]被发现时无处罚，只要此局还未根据第\ref{222}节规则\ref{2221}的措辞结束并且比赛应从因此产生的状态继续；或\\
    ...
    \item 如果所有点位都被占，那么彩球应被摆放得尽可能接近它自身的点位，且在此点位和顶库[与此点位]最接近的部分之间。\\
    ...
    \item 在粉球和黑球[摆上点位]的情形中，如果所有点位都被占且在相应的点位和顶库[与此点位]最接近的部分之间没有可用的空间，那么彩球应被摆放得尽可能接近它自身的点位且在球台\longitudinalline{}上。\\
    ...
    \item 为被恰当地摆上点位，彩球必须被摆放到本规则所\designate{}的点位上。\\
...
\begin{enumerate}[label=(\alph*)]
    \item 如果一次击球结束时母球贴住一颗或多颗活球, 或可以成为活球的球，那么裁判应宣告“贴球”并且，若有任意[球员的] [何球被贴的]疑问，则应\indicate{}母球贴住哪颗或哪几颗活球。如果在一颗红球(或一颗被指定当成红球的自由球)已被击球入袋后母球贴住一颗或多颗彩球，那么裁判还应要求击球手\declare{}他们以哪颗球为活球。\\
    ...
    \item 当母球贴住一颗活球和一颗非活球时，裁判应只\indicate{}贴住的活球。如果击球手问裁判母球是否也贴住非活球，那么他们有权被告知。\\
    ...
    \item 如果裁判[根据实际情况]认为击球时刻贴住的球的任意移动不是由击球手造成的\footnote{例如击球手的动作本不可能造成贴住的球移动，但因静电，贴住的球在母球被打离后有微小移动。}那么不是犯规。\\
    ...
    \item 如果一颗，当被裁判检查时没有贴住母球的，静止的目标球之后在一次击球已被进行前被发现和母球接触了，此球应被裁判按他们所认为的[原位]置回原位。这亦适用于一颗[之前]贴住的且之后，当被裁判检查时，没有贴住的球。\\
...
\begin{enumerate}[label=(\alph*)]
    ...
    \item 如果一次犯规或一次\termpenalty{}既没有被裁判判定，也没有在下一次击球被进行前被非击球手成功地申明，那么它被忽略。\\
    ...
    \item 任何没有被正确地摆上点位的彩球都应保持于原位而例外是若其离开台面则其应被正确地摆上点位。\\
    ...
    \item 在一次犯规被判定前的一次单杆中得到的所有分数都应算入但击球手不应在一次犯规的击球中因任何掉袋的球而得到任何分数。\\
    ...
    \item 下一次击球被从母球静止处进行或，若母球不处于比赛中状态，则被从手中球状态起进行。\\
    ...
    \begin{enumerate}[label=(\roman*)]
        ...
        \item 一颗依击球手选择的彩球，当活球之前是已被击球入袋的一颗红球之后的，或已被击球入袋的一颗被指定当成红球的自由球之后的，一颗彩球时。\\
...
\noindent 下列行为是犯规并招致四罚分除非在下面的段落\ref{22311a}至\ref{22311d}中更高的罚分被\indicate{}。\\
...
\begin{enumerate}[label=(\alph*),start=1]
    ...
    \end{enumerate}
    \item \label{22311b}活球或所涉及的球的分值，其中更高的，因：\\
    ...
    \begin{enumerate}[label=(\roman*)]
        ...
        \item 造成母球首先击中非活球或，当一颗自由球被指定时，造成母球首先击中任意不是被指定的自由球的球除非它和一颗活球被同时击中。\\
        ...
        \item 以球员的身体、衣服或装备的任意部分，接触一颗处于比赛中状态的球，或任意用于标注一颗处于比赛中状态的球的装置；\\
        ...
        \item 造成一颗处于比赛状态中的球接触任意当前击球轮中或之前击球轮中留在球台附近或台面上的物体或装备；\\
    ...
    \end{enumerate}
    \item 活球的分值或两颗所涉及的球中更高的分值因造成母球首先同时击中，不是两颗红球(当红球是活球时)或一颗被指定的自由球和一颗活球的，两颗球。\\
    ...
    \begin{enumerate}[label=(\roman*)]
        ...
        \item 在连续的击球中击打多颗红球，或一颗被指定的自由球后的一颗红球；\\
        ...
        \item 在被裁判要求如此做时未\declare{}他们以为活球的球；或\\
    ...
    \end{enumerate}
\end{enumerate}
\noindent 下列行为是\termpenalty{}并招致四罚分除非在下面的段落\ref{22311e}至\ref{22311g}中更高的罚分被\indicate{}。\\
...
\begin{enumerate}[label=(\alph*),start=5]
    \item \label{22311e}活球或所涉及的球的分值，其中更高的，因如第\ref{223}节规则\ref{2233}\ref{2233k}中所述在击球轮外造成违规。\\
    ...
    \item 七分如果在磋商时间内任意球员，以他们身体、衣服或装备的任意部分，接触任意在\playingarea{}中的球。\\
...
\noindent 在一次犯规后，如果母球被做斯诺克(\see{}第\ref{222}节规则\ref{22217})，那么裁判应宣告“自由球”。\\
...
\begin{enumerate}[label=(\alph*)]
    ...
    \begin{enumerate}[label=(\roman*)]
        ...
        \item 任何被指定的自由球都应被视为，并赋予分值成，活球但区别在于，若被击球入袋，则其应随后被摆上点位。\\
    ...
    \begin{enumerate}[label=(\roman*)]
        ...
        \item \label{22312bii}在一次没有得分的击打后被被指定的自由球对所有红球或彼活球做斯诺克，除当台面上仅剩两目标球例如粉球和黑球，或如第\ref{223}章，规则\ref{2237}所述的黑球和另一彩球时。\\
        after a non-scoring stroke, be snookered on all Reds or the ball on by the nominated free ball, except when there are only two object balls remaining on the table i.e. Pink and Black, or Black and one other colour as described in Section \ref{223}, Rule \ref{2237}.
    \end{enumerate}
    ...
    \item 如果一颗活球在母球首先击中被指定的自由球后，或在同时击中[此球]和一颗活球后，被击球入袋，那么活球应被计分并保持离开台面。\\
    ...
    \item 如果违规者被要求再次击打，或球摆回的要求被非违规者做出(如第\ref{223}节规则\ref{22310}\ref{22310i}、\ref{22314}\ref{22314b}、\ref{22314}\ref{22314e}和\ref{22316}中[所述])，那么自由球选项变得无效。\\
...
\noindent 一旦在一次犯规后一位球员已要求一位对手再次击打或在一次犯规或一次犯规且\miss{}后已要求球摆回，此要求就不可撤回。已被要求再次击打的，违规者有权：\\
...
\subsection{犯规且\miss{}}\label{22314}

\begin{enumerate}[label=(\alph*)]
    \item \label{22314a}击球手应，以他们的最大能力，尽力击中活球，或者在一颗红球已被击球入袋后的，或一颗被指定当成红球的自由球已被击球入袋后的，可以是活球的球。如果裁判认为此规则被违反\footnote{在职业比赛中通常只要击球手未能击中活球或在一颗红球或一颗被指定当成红球的自由球已被击球入袋后的可以是活球的球，裁判就认为此规则被违反，除非击中活球或在一颗红球或一颗被指定当成红球的自由球已被击球入袋后的可以是活球的球确实十分困难。在其他比赛中裁判的判罚可以宽松。}，那么他们应宣告“犯规且\miss{}”\footnote{一般情形的“犯规且\miss{}”也称“无意识救球”。}除非：\\
    ...
    \begin{enumerate}[label=(\roman*)]
        \item \label{22314ai}任意球员在被进行的击球前需要罚分[才能获胜]，或由于被进行的击球而需要罚分[才能获胜]，并且裁判认为\miss{}不是故意的；\\
        ...
        \item 不可能击中活球的情况成为实际。在后一种情形中前提必须是击球手正尝试击中活球，只要他们向活球用足够的力量，直接地或间接地，击打并且，在裁判看来，若没有阻挡的球则已击及活球。\\
    ...
    \end{enumerate}
    \item \label{22314b}在一次“犯规且\miss{}”已被宣告后，非违规者可以要求违规者从留存的状态或原来的状态再次击打，且在后一种情形中所有的球都应被摆回并且活球应和最后一次被进行的击球前它是的相同，也就是说：\\
    ...
    \begin{enumerate}[label=(\roman*)]
        ...
        a colour of the striker's choice, where the ball on was a colour after a Red, or a free ball nominated as a Red had been potted.
    \end{enumerate}
    \item \label{22314c}当有一条从母球到任意是或任意可以是活球的球的清晰的直线线路时如果击球手，在进行一次击球时，未能首先击中一颗活球，那么裁判应宣告“犯规且\miss{}”除非如第\ref{223}节规则\ref{22314}\ref{22314a}\ref{22314ai}中所述。\\
    ...
    \item \label{22314d}当有一条从母球到任意是或任意可以是活球的球的清晰的直线线路，以致中心的，整球的，接触是可行的(在红球[是活球]的情形中，这被理解成[有一条从母球到]任意红球的不被彩球阻挡的整个直径[的清晰的直线线路])，或母球与可以是活球的球相贴时，在一次“犯规且\miss{}”\footnote{此情形的“犯规且\miss{}”也称“无意识击球”。}已根据上面段落\ref{22314c}被宣告后：\\
    ...
    \begin{enumerate}[label=(\roman*)]
        \item \label{22314di}在从原来的状态进行的一次击球时的第二次首先击中活球的失败应被无视分差地宣告“犯规且\miss{}”；\\
        ...
        \item \label{22314dii}如果是如上面\ref{22314di}中[所述]的第二次失败，那么若被要求从原来的状态再次击打，则违规者应被裁判警告接下来的失败会导致此局被判定他们的对方赢得。然而，如果警告未被宣布那么一局不能被判定赢得。如果裁判未宣布警告，那么只要“犯规且\miss{}”的宣告序列已继续，击球手就会在首个可行的机会被警告；\\
        ...
        \item 如果被要求从留存的状态击打，那么如\ref{22314d}\ref{22314di}和\ref{22314d} \ref{22314dii}中[所述]的“犯规且\miss{}”序列终止。\\
    ...
    \end{enumerate}
    \item \label{22314e}在所有球都已被根据本规则摆回, 且击球手对, 包括母球在内的, 任意球犯规后，如果击球还未被进行那么\miss{}不会被宣告。在此情形中适当的处罚会被推行。非违规者可以随后选择自己从留存的状态击打，或要求违规者从留存的状态或原来的状态再次击打，且在后一种情形中所有球都应被摆回并且活球应和最后一次被进行的击球前它是的相同，也就是说：\\
    ...
    \begin{enumerate}[label=(\roman*)]
        ...
        a colour of the striker's choice, where the ball on was a colour after a Red, or a free ball nominated as a Red had been potted.
    \end{enumerate}
    如果上面的情况发生在如上面段落\ref{22314d}中所述的“犯规且\miss{}”的宣告序列中，那么任何涉及可能的判定此局他们的对方赢得的警告都应只在所有球都已被摆回违规前它们原来的位置时才仍有效。\\
    ...
    \item 如果，在一次“犯规且\miss{}”被宣告后，从原来的状态击打的要求被做出，那么磋商时间开始。\\
...
\noindent 如果一颗，静止的或正运动的，球被碰到但不因击球手，那么它应被裁判摆回他们认为球本在的，或本会静止到的，位置且不处罚击球手。\\
...
A consultation period starts when the decision is made to replace the ball(s).
\begin{enumerate}[label=(\alph*)]
    \item 本规则应包括另一干扰或另一，不是击球者的搭档的，人员造成击球手移动球的情况，但不会适用于球因球台表面的任何负面效应而移动的情况，除在下一次击球已被进行前被摆上点位的球移动的情况外。\\
...
\noindent 除击打母球以进行一次击球外，或在磋商时间内接触球外，如果任意球被击球手故意从\playingarea{}中移动或拿起\footnote{此时裁判可根据第\ref{224}节中的规则做出相应判罚。}，那么裁判应宣告“犯规”。\\
...
\begin{enumerate}[label=(\alph*)]
    ...
    \begin{enumerate}[label=(\roman*)]
        \item 选择自己或要求他们的对手从留存的状态击打。在此情况中，任何没有静止于\playingarea{}中的球都会被视为已被迫离台面。\\
        ...
        \begin{enumerate}[label=(\roman*)]
            ...
            a colour of the striker's choice, where the ball on was a colour after a Red, or a free ball nominated as a Red had been potted.
        \end{enumerate}
        如果上面的情况发生在如第\ref{223}节规则\ref{22314}\ref{22314d}中所述的“犯规且\miss{}”的宣告序列中并且让违规者再次击打的要求被做出，那么任何涉及可能的判定此局他们的对方赢得的警告都应仍有效。\\
...
\noindent 如果裁判认为僵局的状态成为实际， 或正被接近，或被双方球员\indicate{}，那么裁判应向球员们提供重开此局的立即选项。此过程习惯上被称为重摆。\\
...
\begin{enumerate}[label=(\alph*)]
    \item 如果任意球员反对，那么裁判应允许比赛继续但限制此情况必须在一定的时段内改变，通常是在每方再来三次击球后但仍按裁判的自行决定权\footnote{在职业比赛中通常只要任意球员反对，裁判就允许比赛继续，哪怕打成喝好多水却上不了厕所的“膀胱局”。}。\\
    ...
    \item 如果僵局出现在如第\ref{223}节规则\ref{2234}\ref{2234b}中所述的\respotted{}黑球期间，那么只有黑球被摆回点位并且相同的球员再次进行开局击打。\\
...
\begin{enumerate}[label=(\alph*)]
    \item 在双打比赛(四位球员分为两方且每方两位球员)中，每方应轮流开局并且比赛次序应被在每局的开始确定且，当被如此确定时，必须在整局内保持不变。\\
    ...
    \item 当一局以平局结束时，第\ref{223}节规则\ref{2234}适用。如果\respotted{}黑球是必要的，那么进行首次击球的一方有哪位球员将进行此次击球的选择权。比赛次序必须随后按此局中[此局的开始所确定的]延续。\\
...
\begin{enumerate}[label=(\alph*)]
    \item 如果违规者被要求从原来的状态再次击打那么不会有多于五次的连续的“犯规且\miss{}”的宣告。\\
    ...
    \item 在第四次连续的“犯规且\miss{}”的宣告后，裁判应警告违规球员如果“犯规且\miss{}”再被宣告那么非违规者可以：\\
    ...
    \begin{enumerate}[label=(\roman*)]
        ...
        \item 自\playingarea{}中的任意位置击打母球，除非任意球员在最后一次被进行的击球前需要罚分[才能获胜]，或由于最后一次被进行的击球而需要罚分[才能获胜]。如果此选项被选择，那么第\ref{223}节规则\ref{22312}不应适用。\\
    ...
    \end{enumerate}
    \item 如果，在一次“犯规且\miss{}”的宣告后，违规者被要求从留存的状态击打，那么之前的“犯规且\miss{}”序列终止。\\
    ...
    \item 在将一颗红球，或一颗被指定当成红球的自由球，击球入袋后，击球手禁止如第\ref{222}节规则\ref{22217}中所述地让他们的对手被在被指定的彩球后做斯诺克。\\
...
\noindent 放置和移除球台附近的击球手可能用到的任何器材都是他们的责任。\\
It is the responsibility of the striker to both place and remove any 
equipment they may use at the table.
\begin{enumerate}[label=(\alph*)]
    \item 击球手对包括，但不限于，他们带去球台的架杆和套筒的所有物品负责，无论是被他们拥有的还是被借来的(除非来自裁判)，并且在使用这样的器材时他们会因任何被[他们]造成的犯规被处罚。\\
    ...
    \item \label{22320b}已被，包括裁判在内的，第三方提供的通常被在球台附近找到的器材不是由击球手担责的。如果这样的器材被证明有问题并因此造成击球手接触一颗或多颗球那么不是犯规。裁判，若有必要，则会根据第\ref{223}节规则\ref{22315}将任何球摆回原位并且击球手，若在一次单杆中，则会被允许继续且无处罚。\\
...
\begin{enumerate}
    \item 诸条件可能需要涉及本规则被适用于残障人员的方式的调整。尤其是例如：\\
    ...
    \begin{enumerate}
        ...
        \item 如果球员无法分辨不同颜色，比如，红色和绿色，那么他们，在要求裁判后，应被告知球的颜色或它的位置。\\

...
\begin{enumerate}[label=(\alph*)]
    \item 球员可以提出认输，但如果他们的对方选择继续比赛那么这变得无效。\\
    ...
    \item \label{2242c}如果一位球员碰触或移动一颗或多颗球以\indicate{}认输提议，那么若认输被他们的对方接受则裁判不会宣告``犯规''或``处罚''。如果认输不被接受，那么第\ref{223}节规则\ref{22316}或第\ref{223}节规则\ref{2233}\ref{2233k}应适用。\\
...
\noindent 如果非击球手离开球台，那么他们可以选定一位代表以照顾他们的利益并若有必要则申明违规。这样的选定必须在离开前让裁判知晓。\\
